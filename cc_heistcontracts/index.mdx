...
exports.cc_heistcontracts:RegisterContract({
    ...
    -- Listen for your heist's completion event. Scoped to this run via the
    -- group match, and removed after it fires so we don't stack handlers.
    local handler
    handler = AddEventHandler('your_heist:complete', function(group, success)
