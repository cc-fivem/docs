...
CreateThread(function()
  ...
  <Step title="(Optional) Register the heist doors">
    <Tabs>
      <Tab title="ox_doorlock">
        ...
        Leave any of them `false` if you manage that heist's doors manually.
      </Tab>
      <Tab title="qb-doorlock">
        `cfg.auto_insert_doors` only targets `ox_doorlock`. On `qb-doorlock`, paste each heist's `Config.DoorList` entries into `qb-doorlock/config/locations.lua` and restart `qb-doorlock`. The full per-heist snippets live on the individual installation pages:

        - [cc_fleecaheist/installation](/cc_fleecaheist/installation) — the five Fleeca branches plus the Pink Cage gate.
        - [cc_paletoheist/installation](/cc_paletoheist/installation) — the Paleto bank doors and thermite door.
        - [cc_pacificheist/installation](/cc_pacificheist/installation) — the Pacific Standard vault, cellar, and reception doors.
      </Tab>
    </Tabs>
  </Step>
