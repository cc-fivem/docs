...
- A FiveM server already running [cc_heistcontracts](/cc_heistcontracts/installation) — every module registers contracts against it.
- [ox_lib](https://github.com/overextended/ox_lib), [oxmysql](https://github.com/overextended/oxmysql), and [ox_target](https://github.com/overextended/ox_target) (`cc_cargoheist`).
- A working `cc_lib` resource.
- [cc_minigames](/cc_minigames/index) — `cc_jewelryheist`'s glass-cut and hack skill checks.
  ...
  <Step title="(Optional) Register the heist doors">
    <Tabs>
      ...
      <Tab title="qb-doorlock">
        ...
        - [cc_jewelryheist/installation](/cc_jewelryheist/installation) — the Vangelico entrance and security-room doors.

        `cc_cargoheist` has no doors.
      </Tab>
    </Tabs>
  </Step>
...
- [Jewelry Heist](/cc_jewelryheist/index) · [installation](/cc_jewelryheist/installation)
