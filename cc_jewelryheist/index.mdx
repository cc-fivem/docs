...
| `weapon_bat` (weapon) | Bat | Smashing the cabinets |

All three already exist in the shipped `ox_inventory` items list. See the [installation guide](/cc_jewelryheist/installation).
